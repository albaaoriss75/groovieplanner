...
export const TRANSLATIONS: Record<Language, Translation> = {
  en: {
    ...
    evening: "Evening Zen",
    resetPlan: "New Plan",
    progressTitle: "Today's Groovie Progress",
    quickTasksTitle: "Daily Groovie Vibes",
    addTaskPlaceholder: "Add a quick task...",
    shareTitle: "Spread the Vibes",
  ...
  bg: {
    ...
    resetPlan: "Нов План",
    progressTitle: "Днешен Groovie Прогрес",
    quickTasksTitle: "Дневни Groovie Задачи",
    addTaskPlaceholder: "Добави бърза задача...",
    shareTitle: "Сподели вайба",
    downloadButton: "Markdown",
    downloadPDF: "Изтегли PDF",
    downloadPNG: "Запази като Снимка",
    shareButton: "Сподели",
    copyButton: "Копирай",
